...
# To view the high level program, please see program1.py
...
# Programming the instructions
memory_instruction[0] = '00000001' + pad_to_k(500,12) + '00001000' + pad_to_k(501,12)
memory_instruction[1] = '00001111' + pad_to_k(100,12) + '00010100' + pad_to_k(1000,12)
memory_instruction[2] = '00100001' + pad_to_k(502,12) + '11110000' + pad_to_k(1000,12)

memory_instruction[100] = '00010101' + pad_to_k(1000,12) + '00010101' + pad_to_k(1000,12)
memory_instruction[101] = '00100001' + pad_to_k(503,12) + '11110000' + pad_to_k(1000,12)
memory_instruction[102] = '11110000' + pad_to_k(1000,12) + '11110000' + pad_to_k(1000,12)
...
data_memory[502] = convert_decimal_to_signMagBinary(0)
